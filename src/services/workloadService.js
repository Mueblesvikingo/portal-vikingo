...
export async function upsertLiderProcesoOverride({ personaId, actividadId, duracionMinutos, activo = true, frecuencia, excluido = false, motivo }) {
  try {
      ...
      .upsert(
        {
          ...
          excluido,
          motivo: excluido ? (motivo || null) : null,
          updated_at: new Date().toISOString(),
        },
