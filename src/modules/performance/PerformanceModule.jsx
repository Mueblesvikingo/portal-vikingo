          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {isEstrategico && (
              <button
                ...
                className={`h-9 rounded-lg px-3 text-[10px] font-black uppercase tracking-widest text-white shadow-sm transition ${
                  activeTab === "despliegue" ? "bg-gradient-to-r from-amber-500 to-orange-600" : "bg-gradient-to-r from-amber-400 to-orange-500 hover:from-amber-500 hover:to-orange-600"
                }`}
              >
