  ...
  function renderAgendaMonthlyPlanning() {
    return (
      ...
      <div className="overflow-x-auto">
        <div className="grid min-w-[860px] grid-cols-[90px_repeat(4,minmax(0,1fr))] border-b border-slate-100 bg-slate-50 text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">
        ...
        {agendaMonthlyMatrix.map((row) => (
          <div key={row.type} className="grid min-w-[860px] grid-cols-[90px_repeat(4,minmax(0,1fr))] border-b border-slate-100 last:border-b-0" style={{ alignItems: "start" }}>
