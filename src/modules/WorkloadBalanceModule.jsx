...
function ProgramAssignmentModal({ modal, draft, setDraft, onSave, onClose, error, capacityWarning, onToggleDay, onToggleWeek }) {
...
export default function WorkloadBalanceModule({
  ...
  const [meetingEditDraft, setMeetingEditDraft] = useState({ titulo: "", prioridad: "Media", gestionarEn: "Planner", horas: 1, fechaLimite: "" });
