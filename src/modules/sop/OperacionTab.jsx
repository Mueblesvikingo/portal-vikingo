      ...
      <div className="max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-2xl bg-white p-5 shadow-xl">
        ...
        <div className="mt-3 space-y-3 text-[10px] font-semibold leading-relaxed text-slate-600">
          ...
          <div>
            ...
            <p className="mt-1">
              En Vista semanal, la demanda es la captura real de esa semana en Plan de venta — no se estima ni se rellena con el plan mensual. Un producto que aún no se captura esa semana en particular cuenta como 0 hasta que un líder lo capture.
            </p>
          </div>
...
function OperacionSemanalView({ productos, parametros, capacidadProcesos, tiemposEstandar, semanaLunes, canEdit, currentUser, onSolicitarRecurso }) {
  ...
  // Demanda real capturada por los líderes para esta semana en Plan de
  // venta — sin estimados: lo que no se ha capturado todavía cuenta como 0
  // hasta que se capture, no se rellena con un promedio del mes.
  const piezasPorProducto = capturaSemana;
